...
**📌 Tip:** Extensions that slow down your browser are a common issue. If you have lots of extensions and your browser is sluggish, see our guide on [Browser Too Many Tabs Running Slow](/guides/browser-too-many-tabs-slow-fix) for more solutions.
...
- **Browser is slow:** Check [Browser Too Many Tabs Running Slow](/guides/browser-too-many-tabs-slow-fix)
- **Browser keeps crashing:** Check [Browser Keeps Crashing](/guides/browser-keeps-crashing-fix)
- **Pages won't load:** Check [Browser Not Loading Pages](/guides/browser-not-loading-pages-fix)
- **One specific website has problems:** Could be the website itself, not your browser
